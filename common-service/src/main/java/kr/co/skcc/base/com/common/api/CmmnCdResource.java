...
public class CmmnCdResource {
    ...
    @GetMapping("/excel")
    public ResponseEntity<HttpStatus> excelDownloadCmmnCd(@RequestParam(required = false) String systmClCd,
                                              @RequestParam(required = false) String chrgTaskGroupCd,
        ...
        cmmnCdService.excelDownloadCmmnCd(systmClCd, chrgTaskGroupCd, cmmnCdNm);
