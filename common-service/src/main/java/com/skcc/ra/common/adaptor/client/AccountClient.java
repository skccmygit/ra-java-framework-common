...
@FeignClient(name = "account-service", url = "${feign.account-service.url:http://localhost:9101}", configuration = {FeignConfig.class})
public interface AccountClient {

    @Schema(name="ID로 계정조회")
    @GetMapping("/api/v1/com/account/user/userid")
