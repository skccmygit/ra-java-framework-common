...
public interface CmmnCdDtlRepository extends JpaRepository<CmmnCdDtl, CmmnCdDtlPK> {
    ...
    @Query(value= "SELECT new com.skcc.ra.common.api.dto.domainDto.CmmnCdDtlDto(t, m.cmmnCdNm, k.cmmnCdNm, l.cmmnCdValNm) " +
            "FROM CmmnCdDtl t " +
    ...
    @QueryHints(@QueryHint(name=COMMENT, value="공통, common, 나태관"))
    @Query(value= "SELECT " +
                "new com.skcc.ra.common.api.dto.domainDto.CmmnCdDtlDto(k,t.cmmnCdNm) " +
