...
public class SendReqDto {
    ...
    @Schema(description = "SMS알림톡구분코드", requiredMode = Schema.RequiredMode.REQUIRED)
    private String smsNotitClCd;

    @Schema(description = "업무", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "수신자전화번호", requiredMode = Schema.RequiredMode.REQUIRED)
